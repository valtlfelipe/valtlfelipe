...
#### ⭐ Recent Stars
- **[wesbos/JSON-Alexander](https://github.com/wesbos/JSON-Alexander)** - A really good JSON viewer browser Extension (today)
- **[TableProApp/TablePro](https://github.com/TableProApp/TablePro)** - Native macOS client for every database (5 days ago)
- **[chroma-core/chroma](https://github.com/chroma-core/chroma)** - Data infrastructure for AI (6 days ago)
