...
#### ⭐ Recent Stars
- **[R44VC0RP/opensend](https://github.com/R44VC0RP/opensend)** - self-hosted transactional &amp; marketing email layer on top of aws ses (1 day ago)
- **[MillionSend/millionsend](https://github.com/MillionSend/millionsend)** - The open-source email platform — self-host on your own AWS SES, or use the cloud. Resend-compatible API. (1 day ago)
- **[shivamanupadi/traks](https://github.com/shivamanupadi/traks)** - Self-hosted, privacy-friendly web analytics that deploys into your own Cloudflare account in two minutes. Free forever, MIT. (1 day ago)
