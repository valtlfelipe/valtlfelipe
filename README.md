...
- **[versity/versitygw](https://github.com/versity/versitygw)** - A simple to deploy but feature rich S3 object storage server for your filesystem (3 days ago)
- **[cloudflare/agentic-inbox](https://github.com/cloudflare/agentic-inbox)** - A self-hosted email client with an AI agent, running entirely on Cloudflare Workers (4 days ago)
- **[faiscadev/fakecloud](https://github.com/faiscadev/fakecloud)** - Local AWS cloud emulator. Free forever. (5 days ago)
