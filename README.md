...
- **[cloudflare/agentic-inbox](https://github.com/cloudflare/agentic-inbox)** - A self-hosted email client with an AI agent, running entirely on Cloudflare Workers (6 days ago)
- **[faiscadev/fakecloud](https://github.com/faiscadev/fakecloud)** - Local AWS cloud emulator. Free forever. (1 week ago)
