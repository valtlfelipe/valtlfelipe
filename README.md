...
#### ⭐ Recent Stars
- **[jkuri/Reframed](https://github.com/jkuri/Reframed)** - Screen recording on macOS, from capture to delivery, no detours.  (1 day ago)
- **[Notifuse/notifuse](https://github.com/Notifuse/notifuse)** - Notifuse is an open-source &amp; modern emailing platform (1 day ago)
- **[getpaykit/paykit](https://github.com/getpaykit/paykit)** - Open-source TypeScript toolkit that unifies multiple payment providers behind a single, extensible API. (1 day ago)
- **[getomnico/omni](https://github.com/getomnico/omni)** - Workplace AI Assistant and Search Platform (1 day ago)
