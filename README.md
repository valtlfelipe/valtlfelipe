...
#### ⭐ Recent Stars
- **[AikidoSec/safe-chain](https://github.com/AikidoSec/safe-chain)** - Protect against malicious code installed via npm, yarn, pnpm, npx, pnpx, pip, uv and poetry with Aikido Safe Chain. Free to use, no tokens required. (today)
...
- **[kamranbekirovyz/skills](https://github.com/kamranbekirovyz/skills)** - AI skills for building beautiful Flutter apps (2 days ago)
