...
#### ⭐ Recent Stars
- **[smol-machines/smolvm](https://github.com/smol-machines/smolvm)** - Tool to build &amp; run portable, lightweight, self-contained virtual machines. (2 days ago)
- **[versity/versitygw](https://github.com/versity/versitygw)** - A simple to deploy but feature rich S3 object storage server for your filesystem (2 days ago)
- **[cloudflare/agentic-inbox](https://github.com/cloudflare/agentic-inbox)** - A self-hosted email client with an AI agent, running entirely on Cloudflare Workers (3 days ago)
- **[faiscadev/fakecloud](https://github.com/faiscadev/fakecloud)** - Local AWS cloud emulator. Free forever. (4 days ago)
