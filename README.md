...
#### ⭐ Recent Stars
- **[lineofflight/country](https://github.com/lineofflight/country)** - IP-to-country geolocation API (3 days ago)
- **[FrontDeskHQ/front-desk](https://github.com/FrontDeskHQ/front-desk)** - Customer support tool to help your customer wherever they are (3 days ago)
- **[R44VC0RP/opensend](https://github.com/R44VC0RP/opensend)** - self-hosted transactional &amp; marketing email layer on top of aws ses (4 days ago)
- **[MillionSend/millionsend](https://github.com/MillionSend/millionsend)** - The open-source email platform — self-host on your own AWS SES, or use the cloud. Resend-compatible API. (4 days ago)
