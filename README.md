...
#### ⭐ Recent Stars
- **[patroni/patroni](https://github.com/patroni/patroni)** - A template for PostgreSQL High Availability with Etcd, Consul, ZooKeeper, or Kubernetes (today)
- **[pgpartman/pg_partman](https://github.com/pgpartman/pg_partman)** - Partition management extension for PostgreSQL (1 day ago)
- **[penpot/penpot](https://github.com/penpot/penpot)** - Penpot: The open-source design tool for design and code collaboration (5 days ago)
