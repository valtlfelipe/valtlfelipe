...
#### ⭐ Recent Stars
- **[watzon/pindrop](https://github.com/watzon/pindrop)** - A native macOS menu bar dictation app using local speech-to-text with WhisperKit (today)
...
- **[Shpigford/chops](https://github.com/Shpigford/chops)** - Your AI agent skills, finally organized. A macOS app to browse, edit, and manage skills across Claude Code, Cursor, Codex, Windsurf, and Amp. (2 days ago)
- **[Shpigford/clearly](https://github.com/Shpigford/clearly)** - A clean, native markdown editor for macOS. (2 days ago)
- **[puiusabin/bun-smtp](https://github.com/puiusabin/bun-smtp)** - SMTP and LMTP server library for Bun (2 days ago)
