...
#### ⭐ Recent Stars
- **[veerendra2/speedtest_exporter](https://github.com/veerendra2/speedtest_exporter)** - A Prometheus exporter for monitoring internet speed with speedtest.net (1 day ago)
- **[wlcrs/huawei_solar](https://github.com/wlcrs/huawei_solar)** - Home Assistant integration for Huawei Solar inverters via Modbus (4 days ago)
- **[firecrawl/anydoc](https://github.com/firecrawl/anydoc)** - Convert Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF to clean Markdown. Built in Rust, with Node.js and Python bindings. (5 days ago)
