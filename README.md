...
#### ⭐ Recent Stars
- **[EvanBacon/serve-sim](https://github.com/EvanBacon/serve-sim)** - The `npx serve` of Apple Simulators. (2 days ago)
- **[malisper/pgrust](https://github.com/malisper/pgrust)** - Postgres rewritten in Rust, now passing 100% of the Postgres regression tests (2 days ago)
- **[pug-sh/pug](https://github.com/pug-sh/pug)** - Open-source product analytics (4 days ago)
