...
#### ⭐ Recent Stars
- **[nylo-core/nylo](https://github.com/nylo-core/nylo)** - Nylo is the fastest way to build your next Flutter mobile app. Streamline your projects with Nylo&#39;s opinionated approach to building Flutter apps. Develop your next idea  ⚡️ (2 days ago)
- **[blitzdotdev/blitz-mac](https://github.com/blitzdotdev/blitz-mac)** - Blitz mac app (2 days ago)
- **[watzon/pindrop](https://github.com/watzon/pindrop)** - A native macOS menu bar dictation app using local speech-to-text with WhisperKit (4 days ago)
