...
#### ⭐ Recent Stars
- **[letsseal/letsseal](https://github.com/letsseal/letsseal)** - The open standard for proving any file is real, unaltered and sealed (2 days ago)
- **[egoist/kero](https://github.com/egoist/kero)** - A native terminal workspace for macOS. (5 days ago)
- **[stablyai/orca](https://github.com/stablyai/orca)** - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop, mobile and VPS. (6 days ago)
